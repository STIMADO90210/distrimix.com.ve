...
if(isset($_GET['nroped']))
 {
	 ...
	 $updateSQL = sprintf("UPDATE clientepedido SET status=%s WHERE id=%s",
						  	GetSQLValueString('2', "int"),
                       		GetSQLValueString($_GET['nroped'], "int"));
 mysql_select_db($database_master, $master);
...
echo "Pedido : ".$cadena.$nroped."<br>";
 ...
 <table width="938" height="76" border="0" bordercolor="#FFFFFF">
  <tr>
   
    <td width="299" align="center"  bgcolor="#CCCCCCC">producto</td>
    <td width="229" align="right"  bgcolor="#CCCCCCC">Precio</td>
    <td width="128" align="right"  bgcolor="#CCCCCCC">Cantidad</td>
    <td width="150" align="right"  bgcolor="#CCCCCCC">Subtotal</td>
  ...
  <tr>
    ...
    <?php  $idcli=$_POST['idcli']?>
    <td align="right"> <a href="histo_pedidos_clientes.php?idreg=<?php echo $idcli?>" class="acount-btn">Volver</a></td>
    <form name="form1" method="post" action="imprimir_detalle_pedido.php">
        <input name="nropedido" id="nropedido" type="hidden" value=<?php echo $nroped ?>>
        <input name="idcli" id="idcli" type="hidden" value=<?php echo $idcli  ?>>
       
        <td align="right"> <!--<input type="submit" name="imprimir" id="imprimir" class="acount-btn" value="Imprimir" /> --> </td>

    </form>
    <td align="left" bgcolor="#FFFFFF" ></td>
        <td width="110" align="right" bgcolor="#FFFFFF">   <a href="detallePed_admin.php?nroped=<?php echo $nroped ?>" class="acount-btn">Despachar</a></td>
