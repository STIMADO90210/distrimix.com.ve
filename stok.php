...
<div class="about">
    <div class="container">
         <div class="register">Stok Del Producto :   <?php echo strtoupper($row_stokpro['producto']) ?> </div>
         <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
           <table width="769" align="center">
             <tr valign="baseline">
               <td nowrap align="right">Categoria :</td>
               <td><?php cat($row_stokpro['categoria'])?></td>
             </tr>
             <tr valign="baseline">
               <td nowrap align="right">Stok Actual :</td>
               <td><?php 
			   echo $row_stokpro['stok'];
			   $stokv=$row_stokpro['stok'];
			   ?></td>
             </tr>
             <tr valign="baseline">
               <td nowrap align="right">Stok Nuevo:</td>
               <td><input type="text" name="stok" value="" size="8"></td>
             </tr>
             <tr valign="baseline">
               <td nowrap align="right">&nbsp;</td>
               <td><input type="submit" value="Actualizar stok"></td>
             </tr>
           </table>
