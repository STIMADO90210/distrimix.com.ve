...
<div class="about">
    <div class="container">
         ...
         <div class="register">
		  	  <h4 class="title"><a href="usuario.php" class="acount-btn">Usuario</a>  <a href="producto.php" class="acount-btn">producto </a>  <a href="lista_pedidos.php" class="acount-btn"> pedidos</a>  <a href="categoria.php" class="acount-btn"> Categorias</a></h4>
		  	  <p class="cart">Desde Aqui tiene acceso a todos los modulos del sistema</p>
		 </div>
	</div>
</div>
<div class="footer_bg">
