...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO subcategoria (subcategoria, categoria) VALUES (%s, %s)",
  ...
  $insertGoTo = "subcategoria_list.php";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <div class="container ">
     ...
     <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
 		...
 		<div class="row form-group">
           	...
           	<div class="col-md-4"><input type="text" name="subcategoria" value="" size="32" placeholder="Escriba la subcategoria"  class="form-control"></div>
     	</div>
        <div class="row form-group">
   			<div class="col-md-1 col-xs-offset-2 ">Categoria:</div>
           	<div class="col-md-4"><select name="categoria" class="form-control">
        ...
        <div class="row form-group">
   			<div class="col-md-2 col-xs-offset-3 "><input type="submit" value="Agregar Subcategoria" class="btn btn-success">  </div>
       	</div>
