...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO producto (producto, categoria, imagen, precio) VALUES (%s, %s, %s, %s)",
...
<div class="about">
    <div class="container">
         <div class="register">
		  	  ...
		  	  <p class="cart">Modulo Para Agregar Productos</p>
	  	   <p class="cart">&nbsp;</p>
           <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
             <table width="754" align="center">
               <tr valign="baseline">
                 <td width="93" align="right" nowrap>Producto:</td>
                 <td width="649"><input type="text" name="producto" value="" size="32"></td>
               </tr>
               <tr valign="baseline">
                 <td height="23" align="right" nowrap>Categoria:</td>
...
?>
               ...
               <tr valign="baseline">
                 ...
                 <input type="button" class="btn btn-success btn-md " name="button" id="button" value="Subir imagen 260x210px" onclick="javascript:subirimagen();"/>
</td>
               </tr>
               <tr valign="baseline">
