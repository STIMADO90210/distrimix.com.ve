  ...
  <div class="container">
      <div class="register">
       ...
       <div class="col-md-6 login-right">
      	...
      	<h3 class="title">2 INFORMACION PERSONAL</h3>
				<p>Registro de Información personal</p>
                
        <form method="post" name="form1" action="registro3.php">
         
		  <div>
		    <span>Nombre<label>*</label></span>
            <span id="sprytextfield1">
					   <input type="text" name="nombre" id="nombre"> </span>
		 </div>
		  <div>
		    <span>Apellido<label>*</label></span>
            <span id="sprytextfield2">
					   <input type="text" name="apellido" id="apellido"> </span>
			</div>
            
            <div>
		    <span>Cedula<label>*</label></span><span id="sprytextfield8">
            <input type="text" name="cedula" id="cedula"></span>
            </div>
